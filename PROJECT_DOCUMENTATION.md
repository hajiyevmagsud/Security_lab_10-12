...
*   **Example from specific file (`user.controller.js`)**:
    ...
    updateProfile = asyncHandler(async (req, res) => {
        ...
        res.status(200).json(ApiResponse.success(200, user, 'Profile updated successfully'));
    });
    ```
...
*   *Note*: This project adds a **Service Layer** (`src/services`), which is a professional best practice to keep Controllers clean. A more accurate name would be "Controller-Service-Model".
...
*   **JSON**: It communicates using JSON data format.
